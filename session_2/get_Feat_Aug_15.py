...
# train = pd.concat([train515,train518,train415,train616,train613,train516,train418],axis=0)
...
tt[['link_ID','date','time_interval','travel_time']].to_csv('./2017-09-15_15_xgb.txt',sep='#',index=False,header=False)
print tt[['link_ID','date','time_interval','travel_time']].shape
print tt[['link_ID','date','time_interval','travel_time']].isnull().sum()


# [430]   validation_0-rmse:0.443893      validation_0-mape:0.273708
# [851]   validation_0-rmse:0.443482      validation_0-mape:0.273409

# [700]   validation_0-rmse:0.444018      validation_0-mape:0.273479
# 3 4 5 6 7
# [853]   validation_0-rmse:0.440541      validation_0-mape:0.273385